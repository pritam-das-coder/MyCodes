...
Entry(f0,textvariable=passvalue).place(relx=0.6,rely=0.6,anchor="center",relwidth=0.4)

Button(f0,text="Login",bg="blue").place(relx=0.5,rely=0.8,anchor="center",relwidth=0.2)
